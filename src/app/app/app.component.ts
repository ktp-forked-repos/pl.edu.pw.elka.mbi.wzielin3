 ...
 * Displays main view and other nested components.
 */
@Component({
  selector: 'app-root',
...
export class AppComponent {
  /** Current simulation. Can be set by clicking start button in the view. */
  simulator: Simulator = null;
  /** Simulation params being inserted in the simulation params editor component */
  inputSimulationParams: SimulationParams = new SimulationParams();
  /** Simulation params of currently running simulation. */
  runningSimulationParams: SimulationParams;
  /** Text displayed as current step explanation. */
  currentStepExplanation: string;
  /** Text displayed as the result of simulation. */
  results: string[] = [];
  /** Demo nested component used to display the 3-dimensional cube */
  @ViewChild(SimulationDemoComponent) simulatorDemoComponent: SimulationDemoComponent;

  /**
   * Default constructor.
   * @param {MatSnackBar} snackBarError used for displaying validation errors.
   */
  ...
  /**
   * Validates input params and starts new simulation.
   */
  startSimulation() {
   ...
   * @returns application event generated by current simulation step.
   */
  step(): AppEvent {
  ...
  /**
   * Translates array to string.
   * @param array array to be translated to string
   * @returns string representing given array
   */
